...
Правила оформления PHP-кода: иммутабельность, запреты статики и самопорождения, именование конструкций.
...
- [Заголовок файла](#заголовок-файла-php-001)
- [Запрещено](#запрещено)
- [Обязательно](#обязательно)
- [Именование](#именование-php-009012)
- [Пример](#пример)
